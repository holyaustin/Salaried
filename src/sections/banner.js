      ...
      <Container>
        <Box sx={styles.grid}>
          <Box as="form" sx={styles.domainCard}>
            <Heading style={{color:`red`, fontSize: '65px', textAlign: 'center', fontWeight: 'bolder'}}>SALARIED</Heading>
            <div style={{fontSize: '26px', marginRight: '0.5rem', fontWeight: 'bold'}}>
              <p>
              A new and secure way to get paid for freelancing through an agent escrow contract. Payment can be multichain. Try it out!.
              </p>
            </div>
            <br />
            <br />
 ...
 */}         
          ...
          <Box as="figure" sx={styles.illustration}>
            <Image src="/images/three.png" loading="lazy" alt="sever-rack" />
          </Box>
        </Box>
      </Container>
    </Box>
