...
const MintFile = () => {
  ...
  const sendTxToBlockchain = async () => {
    ...
    try {
      setTxStatus("Executing transaction to Polygon Mumbai Blockchain.");
      ...
      await Tx.wait();
      console.log("Txn successfully created and added to Blockchain");
